...
/**@var CITBServiceLogList $component */
$component = $this->getComponent();
?>
<?php if ($component->getHelper()->getAction() == 'list') : ?>
    <?php $APPLICATION->SetTitle(Loc::getMessage('ITB_SERVICE.LOG.LIST.PAGE_TITLE')); ?>
    ...
    <? $APPLICATION->IncludeComponent('bitrix:main.ui.grid', '', [
        ...
        'NAV_OBJECT' => $component->getGridHelper()->getNavigation(),
        'AJAX_MODE' => 'Y',
...
<?php else: ?>
    ...
    $APPLICATION->IncludeComponent(
        ...
        '',
        [
            'POPUP_COMPONENT_NAME' => 'itbizon:service.log.' . $component->getHelper()->getAction(),
