...
/**@var $arResult array * */
/**@var CITBFinanceVaultList $component * */
        ...
        <div class="col">
            ...
            if(Permission::getInstance()->isAllowVaultAdd()) {
                Toolbar::addButton(new Button([
                    ...
                    "text" => Loc::getMessage('ITB_FIN.VAULT_LIST.BUTTON.CREATE_VAULT'),
                ]));
                Toolbar::addButton(new Button([
                    "color" => Color::PRIMARY,
                    "click" => new JsCode(
                        'document.location.href="' . $component->makeAddGroupLink() . '";'
                    ),
                    "text" => Loc::getMessage('ITB_FIN.VAULT_LIST.BUTTON.CREATE_VAULT_GROUP'),
                ]));
            }
            ?>
        </div>
