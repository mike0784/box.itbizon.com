            ...
            <div class="col">
                ...
                if($permission->isAllowRequestTemplateAdd())
                {
                    $linkButton = new Button([
                        ...
                        "text" => Loc::getMessage('ITB_FIN.REQ_TEMPLATE.LIST.BUTTON.CREATE'),
                    ]);
...
<?php else: ?>
    ...
    if(isset($_REQUEST['IFRAME']) && $_REQUEST['IFRAME'] == 'Y') {
        $APPLICATION->IncludeComponent(
            ...
            '',
            array(
                'POPUP_COMPONENT_NAME' =>  'itbizon:finance.requesttemplate.' . $arResult['VARIABLES']['ACTION'],
        ...
        $APPLICATION->IncludeComponent(
        /** @var array $arResult */
            'itbizon:finance.requesttemplate.' . $arResult['VARIABLES']['ACTION'],
            '',
            [
                'FOLDER' => $arResult['FOLDER'],
                'TEMPLATE_LIST' => $arResult['URL_TEMPLATES']['list'],
