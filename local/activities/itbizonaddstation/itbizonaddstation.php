...
class CBPItbizonAddStation extends CBPActivity
{
    ...
    public function Execute()
    {
        try {
            ...
            CIMNotify::Add(array(
                ...
                "NOTIFY_TYPE"           => 2,
                "NOTIFY_MESSAGE"        => "Создана станция ID: " . $this->StationId,
                "NOTIFY_MESSAGE_OUT"    => "",
